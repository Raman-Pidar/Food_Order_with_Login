...
export const cuisineData = [
  { id: 1, name: "Italian", reviews: [], averageRating: 4, selected: false },
  { id: 2, name: "Mexican", reviews: [], averageRating: 4, selected: false },
  { id: 3, name: "Chinese", reviews: [], averageRating: 4, selected: false },
  { id: 4, name: "Indian", reviews: [], averageRating: 4, selected: false },
];
...
export default function ContextFun({ children }) {
  ...
  const [couisineFilter, setCouisineFilter] = useState("1");
